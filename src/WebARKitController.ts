...
export default class WebARKitController {
  ...
  private webarkit: delegateMethods;
  ...
  /**
   * The WebARKitController constructor. It has 4 params (see above).
   * These properties are initialized:
   * options, id, width, height, image, orientation, cameraParam, cameraId,
   * cameraLoaded, webarkit, listeners, nftMarkers, transform_mat,
  ...
  static async init(image: ImageObj, cameraUrl: string, width: number, height: number) {
    const _arx = new WebARKitController(image, cameraUrl, width, height);
  ...
  async start() {
    ...
    if (success) {
      ...
      if (this.cameraParaFileURL !== '') {
        try {
          arCameraURL = await this.webarkit.loadCameraParam(this.cameraParaFileURL)
  ...
  /**
   * This is one of the most important method inside WebARKitController.
  ...
  /**
  * Sets imageData and videoLuma as properties to WebARKitController object to be used for marker detection.
  ...
  */
  private _prepareImage (sourceImage: ImageObj) {
    ...
    if (this.videoLuma) {
     ...
     const params: delegateMethods['videoMalloc'] = this.webarkit.instance.videoMalloc;
  ...
  /**
  * Returns the projection matrix computed from camera parameters for the WebARKitController.
  * @param nearPlane {number} the near plane value of the camera.
  * @param farPlane {number} the far plane value of the camera.
  * @return {Float32Array} The 16-element WebGL camera matrix for the WebARKitController camera parameters.
  */
  public getCameraProjMatrix(nearPlane = 0.1, farPlane = 1000) {
    ...
    this.camera_mat = new Float32Array(this.webarkit.instance.HEAPU8.buffer, this._projectionMatPtr, cameraMatrixElements)
    if (cameraMatrix) {
  ...
  /**
     * Loads a trackable into the webarkit contect by calling addTrackable on the webarkit native interface
     *
  ...
  /**
   * Returns the 16-element WebGL transformation matrix used by WebARKitController process to
   * pass marker WebGL matrices to event listeners.
   * Unique to each WebARKitController.
   * @return {Float64Array} The 16-element WebGL transformation matrix used by the WebARKitController.
   */
  ...
  /**
   * Returns the projection matrix computed from camera parameters for the WebARKitController.
   * @return {Float64Array} The 16-element WebGL camera matrix for the WebARKitController camera parameters.
   */
   ...
   * webarkit.LabelingThresholdMode.AR_LABELING_THRESH_MODE_MANUAL,
   * webarkit.LabelingThresholdMode.AR_LABELING_THRESH_MODE_AUTO_MEDIAN,
   * webarkit.LabelingThresholdMode.AR_LABELING_THRESH_MODE_AUTO_OTSU,
   * webarkit.LabelingThresholdMode.AR_LABELING_THRESH_MODE_AUTO_ADAPTIVE,
   * webarkit.LabelingThresholdMode.AR_LABELING_THRESH_MODE_AUTO_BRACKETING
  ...
  public setThresholdMode (mode: number) {
    this.webarkit.setTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_THRESHOLD_MODE.value, mode)
  };
  ...
  public getThresholdMode () {
    return this.webarkit.getTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_THRESHOLD_MODE.value)
  };
  ...
  public setThreshold (threshold: number) {
    ...
    this.webarkit.setTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_THRESHOLD.value, threshold)
  };
  ...
  */
  public getThreshold () {
      return this.webarkit.getTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_THRESHOLD.value)
  };

  /**
       Set the pattern detection mode

       The pattern detection determines the method by which webarkit
       matches detected squares in the video image to marker templates
       and/or IDs. webarkit v4.x can match against pictorial "template" markers,
       ...
       @param {number} mode
           ...
           webarkit.AR_TEMPLATE_MATCHING_COLOR
           webarkit.AR_TEMPLATE_MATCHING_MONO
           webarkit.AR_MATRIX_CODE_DETECTION
           webarkit.AR_TEMPLATE_MATCHING_COLOR_AND_MATRIX
           webarkit.AR_TEMPLATE_MATCHING_MONO_AND_MATRIX
  ...
  public getPatternDetectionMode () {
    return this.webarkit.getTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_PATTERN_DETECTION_MODE.value)
  };
  ...
  /**
    ...
    @param      type The type of matrix code (2D barcode) in use. Options include:
      webarkit.ARMatrixCodeType.AR_MATRIX_CODE_3x3
      webarkit.ARMatrixCodeType.AR_MATRIX_CODE_3x3_HAMMING63
      webarkit.ARMatrixCodeType.AR_MATRIX_CODE_3x3_PARITY65
      webarkit.ARMatrixCodeType.AR_MATRIX_CODE_4x4
      webarkit.ARMatrixCodeType.AR_MATRIX_CODE_4x4_BCH_13_9_3
      webarkit.ARMatrixCodeType.AR_MATRIX_CODE_4x4_BCH_13_5_5
      The default mode is webarkitjs.ARMatrixCodeType.AR_MATRIX_CODE_3x3.
  ...
  public setMatrixCodeType (type: number) {
    this.webarkit.setTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_MATRIX_CODE_TYPE.value, type)
  };
  ...
  public getMatrixCodeType () {
    return this.webarkit.getTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_MATRIX_CODE_TYPE.value)
  };
  ...
  /**
    ...
    @param {number}      mode
    Options for this field are:
    webarkit.AR_LABELING_WHITE_REGION
    webarkit.AR_LABELING_BLACK_REGION
    The default mode is AR_LABELING_BLACK_REGION.
   */
  public setLabelingMode (mode: number) {
    this.webarkit.setTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_LABELING_MODE.value, mode)
  };
  ...
  public getLabelingMode () {
    return this.webarkit.getTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_LABELING_MODE.value)
  };
   ...
   * width/height. To set the default, pass webarkit.AR_PATT_RATIO.
   */
  public setPattRatio (pattRatio: number) {
    this.webarkit.setTrackerOptionFloat(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_BORDER_SIZE.value, pattRatio)
  };
   ...
   */
  public getPattRatio () {
    return this.webarkit.getTrackerOptionFloat(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_BORDER_SIZE.value)
  };
  ...
  /**
    ...
    webarkit processes all pixels in each incoming image
    to locate markers. When the mode is AR_IMAGE_PROC_FIELD_IMAGE,
    webarkit processes pixels in only every second pixel row and
    ...
    @param {number} mode
      Options for this field are:
      webarkit.AR_IMAGE_PROC_FRAME_IMAGE
      webarkit.AR_IMAGE_PROC_FIELD_IMAGE
      The default mode is webarkit.AR_IMAGE_PROC_FRAME_IMAGE.
   */
  public setImageProcMode (mode: number) {
    this.webarkit.setTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_IMAGE_PROC_MODE.value, mode)
  };
  ...
  public getImageProcMode () {
    return this.webarkit.getTrackerOptionInt(this.webarkit.TrackableOptions.ARW_TRACKER_OPTION_SQUARE_IMAGE_PROC_MODE.value)
  };
  ...
  /**
   * Used internally by WebARKitController, it permit to add methods to this.
   * @return {any} WebARKitController
   */
